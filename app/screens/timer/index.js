            ...
            <ContainerComponent title="About Us">
                <View style={{flex: 1, justifyContent: 'center', padding: 10, backgroundColor: '#ED1C24'}}>
                    <Text style={{fontSize: 16, fontWeight: '200', alignSelf: 'center', color: 'white',}}>
                        This app is designed to assist in ensuring that checks are completed after hot works have taken
                        place in particular work areas. The provision to take photographs and emailed reports allows
                        evidence to be collated with regards to these safety checks being carried out.
                    </Text>
